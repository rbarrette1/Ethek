...
<html lang="en-us" ng-app="myApp">
	...
	<body id="tutorialBody">
		<?php require_once 'templates/loginheader.php'; ?>
			<h1>How to change your background picture</h1>
			<div class="imgContainer">
			
					<div class="img current" id="img1">
				
						<img id="win" src="./sitepics/findpic.png" alt="desktop1" usemap="#map1"> 
						<map>
					...
					<div class="img" id="img2" >
						...
						<img id="win" src="./sitepics/doubleclick.png" alt="desktop2" usemap="#map2"> 	
						<map>
					...
					<div class="img" id="img3" >
						...
						<img id="win" src="./sitepics/....png" alt="desktop3" usemap="#map3"> 
						<map>
					...
					<div class="img" id="img7" >
						...
						<img id="win" src="./sitepics/setas.png" alt="desktop7" > 			
					...
					<div class="img" id="img8" >
						...
						<img id="win" src="./sitepics/voila.png" alt="desktop8" > 			
