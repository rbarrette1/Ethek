 ...
 <?php
  ...
  if (mysqli_num_rows($data) == 1) {
    ...
    $row = mysqli_fetch_array($data);
		...
		echo '<tr>';
			echo '<td>';
				echo '<h1 id="profileheading">Your Profile</h1>';
			echo'</td>';
			echo'<td></td>';
		echo'</tr>';
		echo'<tr>';
			echo'<td id="table">';
				echo'<img src="sitepics/logo.png">';
			echo'</td>';
			echo'<td id="table">';
				...
				echo '<h3>Your Interests:</h3>';

			echo '</td>';
		echo'</tr>';
	echo'</table>';
	echo'<h2>Recommended Tutorials For You</h2>';

	echo'<h2>Most Watched Tutorials By You</h2>';
	
	echo'<h2>Tutorials You Have Completed</h2>';
